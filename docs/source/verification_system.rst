Verification System Code Examination
====================================

.. The format is inspired by "https://docs.ros.org/en/jazzy/Tutorials/Beginner-Client-Libraries/Writing-A-Simple-Cpp-Publisher-And-Subscriber.html"

This page explains how the Verification System works in detail. You can find the
implementation details, function definitions, algorithm flow charts, and other crucial
information here.
